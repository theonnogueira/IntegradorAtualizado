...
import com.generarion.InformacaoMudaMundo.service.UsuarioService;
...
//	
//	@Autowired
//	private UsuarioRepository UseRe;
//	
//	@GetMapping("/all")
//	public ResponseEntity<List<Usuario>> getAll(){
//
...
//	@GetMapping("/id")
//	public ResponseEntity<Usuario> getById(@PathVariable long id){
//		return UseRe.findById(id).map(resp -> ResponseEntity.ok(resp))
